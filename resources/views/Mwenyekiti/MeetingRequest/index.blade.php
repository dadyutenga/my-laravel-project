            ...
            <div class="dashboard-content">
                ...
                <div class="stats-row">
                    <div class="stat-card">
                        ...
                        <div class="stat-value">{{ $meetingRequests->where('status', 'pending')->count() }}</div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">{{ $meetingRequests->where('status', 'approved')->count() }}</div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">{{ $meetingRequests->where('status', 'rejected')->count() }}</div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">{{ $meetingRequests->total() }}</div>
                    </div>
                </div>
