...
<body>
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="title">Kichwa cha Tatizo *</label>
                                <input type="text" 
                                       id="title" 
                                       name="title" 
                                ...
                                <div class="char-counter">
                                    <span id="title-count">0</span>/255 herufi
                                </div>
                                @error('title')
                        ...
                        <div class="form-row full-width">
                            <div class="form-group">
                                <label for="tags">Maneno Muhimu (Yachanganye kwa koma)</label>
                                <input type="text" 
                                       id="tags" 
                                       name="tags" 
                                       class="form-control @error('tags') is-invalid @enderror" 
                                       value="{{ old('tags') }}" 
                                       placeholder="Mfano: akaunti, data, matatizo">
                                <small class="text-muted">Andika maneno yanayohusiana na tatizo lako</small>
                                @error('tags')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    <script>
        ...
        updateCharCount('title', 'title-count', 255);
