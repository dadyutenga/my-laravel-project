...
<head>
    ...
    <title>View Service Requests | Prototype System</title>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($serviceRequests as $service)
                                    <tr>
                                        <td>{{ $service->title }}</td>
                                        <td>{{ $service->title_sw ?? 'N/A' }}</td>
                                        <td>{{ $service->mtaa ?? 'N/A' }}</td>
                                        <td>
                                            <span class="status-badge 
                                                @if($service->status == 'pending') status-pending
                                                @elseif($service->status == 'approved') status-approved
