        ...
        <div class="main-content">
            ...
            <div class="dashboard-content">
                <div class="form-container">
                    ...
                    <form method="POST" action="{{ route('balozi.malalamiko.store') }}">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="mtaa" name="mtaa" class="form-control @error('mtaa') is-invalid @enderror" value="{{ old('mtaa') }}" required>
                                @error('mtaa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="malalamiko">Malalamiko</label>
                                <input type="text" id="malalamiko" name="malalamiko" class="form-control @error('malalamiko') is-invalid @enderror" value="{{ old('malalamiko') }}" required>
                                @error('malalamiko')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
