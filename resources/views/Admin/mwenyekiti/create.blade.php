...
<head>
    ...
    <title>Create Mwenyekiti | Prototype System</title>
        ...
        <div class="main-content">
            ...
            <header class="header">
                <div class="header-left">
                    ...
                    <h1 class="page-title">Create Mwenyekiti</h1>
            ...
            <div class="dashboard-content">
                <h2 class="dashboard-title">Create New Mwenyekiti</h2>
                ...
                <div class="form-container">
                    <form action="{{ route('admin.mwenyekiti.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Mwenyekiti</button>
